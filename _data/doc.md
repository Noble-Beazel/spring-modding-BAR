...
```lua
function Spring.CreateUnit(unitDefName: string|number, x: number, y: number, z: number, facing: 0|1|2|3, teamID: integer, build?: boolean, flattenGround?: boolean, unitID?: integer, builderID?: integer)
  -> unitID: number|nil
```
...
```lua
function Spring.SetFeatureResurrect(featureID: integer, unitDef: string|integer, facing?: 0|1|2|3, progress?: number)
  -> nil
```
...
```lua
function Spring.TestBuildOrder(unitDefID: integer, x: number, y: number, z: number, facing: 0|1|2|3)
  -> blocking: 0|1|2|3
  2. featureID: integer?
```
